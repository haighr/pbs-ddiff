...
/** get_ft
  ...
  RF added this one for delay difference model - no age vectors
  Can use an if statement here because no differentiation - DO NOT USE this if solving the Baranov eq during estimation!
*/
	...
	double ft;
	 if(ct<b){
		...
		for(int i=1;i<=50;i++)
		{
			...
			double t3 = o*b;
			//predicted catch
			double pct = t2*b;			  //baranov equation pct = f/z(1-e^-z)b
